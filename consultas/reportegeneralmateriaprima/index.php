...
$titulo="Reporte de General de Materia Prima en Inventario";
$folder="../../";
include_once("../../funciones/funciones.php");

include_once("../../class/productos.php");
$productos=new productos;
$prod=todolista($productos->mostrarTodos("codproductos IN(SELECT  codproductos FROM compra WHERE tipo='' GROUP BY codproductos)","nombre"),"codproductos","nombre","");
