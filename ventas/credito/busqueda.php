...
if (!empty($_POST)) {
	...
	foreach($ventageneral->mostrarTodo("$cuota and codcliente LIKE '$codcliente' and codvendedor LIKE '$codvendedor' and coddistribuidor LIKE '$coddistribuidor' and fechaultimopago LIKE '$fechaultimopago' and fechaventa LIKE '$fechaventa' and codigocontrol LIKE '$codigocontrol'")as $mp){$i++;
